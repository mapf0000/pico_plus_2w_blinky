...
- Reviewed current examples (`crates/dsl/examples/`) and observed repeated inline key sequences; function support now covers the common “greet + type” pattern without duplicating `text` blocks.
